...
var Answer = React.createClass({
    ...
    handleVoteUp: function () {
        ...
        window.sf.answerAction(action, id, event);
    },
        ...
        return (
            <div className="comment">
                ...
                <div className="btn-box">
                    <a href="javascript:void(0)" onClick={this.handleVoteUp} className={this.state.isLiked? "active": ""}><i className="vote-up" style={{"margin": "0 7px 0 3px"}}></i><span>有用</span></a>
                    <a href="javascript:void(0)" onClick={this.handleVoteDown} className={this.state.isHated? "active": ""}><i className="vote-down" style={{"margin": "0 3px"}}></i></a>
